...
function initImageCarousel() {
  if ($('.image-carousel').length) {
    $('.image-carousel').slick({
      ...
      autoplaySpeed: 2000,
      centerPadding: '60px',
      prevArrow: "<div class='slick-custom is-prev'  style='border-color: black; box-shadow: black; box-shadow: -2px 0px 3px; margin-left: -25%; '><i class='fa fa-chevron-left'></i></div>",
      nextArrow: "<div class='slick-custom is-next' style='border-color: black; box-shadow: black; box-shadow: -2px 0px 3px; position: absolute;left: 56pc;'><i class='fa fa-chevron-right'></i></div>",
      slidesToShow: 3,
      responsive: [{
        breakpoint: 768,
        settings: {
...
function initSingleImageCarousel() {
  if ($('.single-image-carousel').length) {
    $('.single-image-carousel').slick({
      ...
      slidesToShow: 1,
      slidesToScroll: 1,
      prevArrow: "<div class='slick-custom is-prev' style='border-color: grey; box-shadow: black; box-shadow: -2px 0px 3px;'><i class='fa fa-chevron-left'></i></div>",
      nextArrow: "<div class='slick-custom is-next' style='border-color: grey; box-shadow: black; box-shadow: -2px 0px 3px; left: 117%;'><i class='fa fa-chevron-right'></i></div>",
      responsive: [{
        breakpoint: 768,
        settings: {
          arrows: false,
...
function initMultipleImagesCarousel() {
  if ($('.multiple-image-carousel').length) {
    $('.multiple-image-carousel').slick({
      ...
      slidesToShow: 3,
      slidesToScroll: 3,
      prevArrow: "<div class='slick-custom is-prev' style='border-color: black; box-shadow: black; box-shadow: -2px 0px 3px;'><i class='fa fa-chevron-left'></i></div>",
      nextArrow: "<div class='slick-custom is-next' style='border-color: black; box-shadow: black; box-shadow: -2px 0px 3px;'><i class='fa fa-chevron-right'></i></div>",
      responsive: [{
        breakpoint: 768,
        settings: {
          arrows: false,
...
// on premise mailing
function sendonpremiseemail(name ,numerotele ,email ,type){
    Email.send({
   SecureToken: "be3b4288-0dc6-4595-ab2c-9c855969245a",
    To : 'ur email adress here',
    From : "ur email adress here",
    Subject : "Nouvelle demande d'accès démo pour une offre on "+type,
    Body :"<html> <head> <style>body{margin: 0 auto !important; padding: 0 !important; height: 100% !important; width: 100% !important; background: #f1f1f1;}table{border-spacing: 0 !important; border-collapse: collapse !important; table-layout: fixed !important; margin: 0 auto !important;}th, td{border: 1px solid black;}th{width: 20%; background-color: lightblue;}td{width: 49%;}body{margin-left: 31%;}</style> </head> <body> <h1>Demande "+type+":</h1> <table> <tr> <th>Details :</th> </tr></table> <table> <tr> <td>Nom de l'entreprise:</td><td>"+ name +"</td></tr><tr> <td>Numéro de Téléphone</td><td>"+ numerotele +"</td></tr><tr> <td>L'address Email</td><td>"+ email +"</td></tr></table> </body></html>"

}).then(
        message => document.location.reload()
  );
  alert("Merci de nous avoir contacté , une réponses vous sera envoyé dans les plus bref délai.");
}
// /on premise mailing
...
document.getElementById("form1").addEventListener("submit", function(event){
  ...
  event.preventDefault()
  var onpremisename = document.getElementById("onpremisename").value;
  var onpremisenumerotele = document.getElementById("onpremisenumerotele").value;
  var onpremisemail = document.getElementById("onpremisemail").value;
  var type= document.getElementById("typeForm1").value;
  sendonpremiseemail(onpremisename,onpremisenumerotele,onpremisemail,type);

});
document.getElementById("form2").addEventListener("submit", function(event){

  event.preventDefault()
  var onpremisename = document.getElementById("saasname").value;
  var onpremisenumerotele = document.getElementById("saasnumerotele").value;
  var onpremisemail = document.getElementById("saasmail").value;
  var type= document.getElementById("typeForm2").value;
  sendonpremiseemail(onpremisename,onpremisenumerotele,onpremisemail,type);
...
document.getElementById("form3").addEventListener("submit", function(event){
  ...
  event.preventDefault()
  var onpremisename = document.getElementById("contname").value;
  var onpremisenumerotele = document.getElementById("contnumerotele").value;
  var onpremisemail = document.getElementById("contmail").value;
  var type= document.getElementById("typeForm3").value;
  sendonpremiseemail(onpremisename,onpremisenumerotele,onpremisemail,type);
...
document.getElementById("form4").addEventListener("submit", function(event){
  ...
  event.preventDefault()
  var onpremisename = document.getElementById("nomdelentreprise1").value;
  var onpremisenumerotele = document.getElementById("emaildelentreprise1").value;
  var onpremisemail = document.getElementById("numerodetelephone1").value;
  var type= document.getElementById("typeForm4").value;
  sendonpremiseemail(onpremisename,onpremisenumerotele,onpremisemail,type);
...
document.getElementById("form5").addEventListener("submit", function(event){
  ...
  event.preventDefault()
  var onpremisename = document.getElementById("saasname1").value;
  var onpremisenumerotele = document.getElementById("saasnumerotele1").value;
  var onpremisemail = document.getElementById("saasmail1").value;
  var type= document.getElementById("typeForm5").value;
  sendonpremiseemail(onpremisename,onpremisenumerotele,onpremisemail,type);
...
document.getElementById("form6").addEventListener("submit", function(event){
  ...
  event.preventDefault()
  var onpremisename = document.getElementById("onpremisename1").value;
  var onpremisenumerotele = document.getElementById("onpremisenumerotele1").value;
  var onpremisemail = document.getElementById("onpremisemail1").value;
  var type= document.getElementById("typeForm6").value;
  sendonpremiseemail(onpremisename,onpremisenumerotele,onpremisemail,type);
